...
public class ModelDioCape<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("jojowos", "model_dio_cape"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition torso_r9 = cape.addOrReplaceChild("torso_r9", CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -4.5F, -0.5F, 18.0F, 22.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r11 = cape.addOrReplaceChild("torso_r11", CubeListBuilder.create().texOffs(0, 39).addBox(-0.5F, -4.5F, -2.5F, 1.0F, 22.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-18.5273F, -6.3867F, -3.0356F, 0.0F, 0.0F, 0.0873F));
		PartDefinition torso_r12 = cape.addOrReplaceChild("torso_r12", CubeListBuilder.create().texOffs(12, 39).addBox(-0.5F, -4.5F, -2.5F, 1.0F, 22.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5588F, -6.3867F, -3.0356F, 0.0F, 0.0F, -0.0873F));
		PartDefinition torso_r13 = cape.addOrReplaceChild("torso_r13", CubeListBuilder.create().texOffs(72, 59).addBox(-3.0F, -1.0F, -0.4997F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.291F, -4.9438F, -5.5559F, -0.0832F, 0.0262F, 0.3043F));
		PartDefinition torso_r14 = cape.addOrReplaceChild("torso_r14", CubeListBuilder.create().texOffs(69, 45).addBox(-3.0F, -0.2662F, -0.1296F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.4529F, -10.6367F, -5.4297F, -0.0873F, 0.0F, 0.0F));
		PartDefinition torso_r15 = cape.addOrReplaceChild("torso_r15", CubeListBuilder.create().texOffs(38, 21).addBox(-4.0F, -0.5F, -0.5F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-9.4529F, -7.3905F, -5.7668F, -0.0852F, -0.0189F, -0.2174F));
		PartDefinition torso_r16 = cape.addOrReplaceChild("torso_r16", CubeListBuilder.create().texOffs(68, 73).addBox(-3.0F, -1.0F, -0.4997F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-15.795F, -4.9438F, -5.5559F, -0.0832F, -0.0262F, -0.3043F));
		PartDefinition torso_r17 = cape.addOrReplaceChild("torso_r17", CubeListBuilder.create().texOffs(67, 36).addBox(-3.0F, -0.2662F, -0.1296F, 6.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-15.6332F, -10.6367F, -5.4297F, -0.0873F, 0.0F, 0.0F));
		PartDefinition torso_r18 = cape.addOrReplaceChild("torso_r18", CubeListBuilder.create().texOffs(56, 100).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.4257F, -11.1133F, 3.3169F, -0.3054F, 0.0F, 0.3054F));
		PartDefinition torso_r19 = cape.addOrReplaceChild("torso_r19", CubeListBuilder.create().texOffs(52, 100).addBox(-0.5007F, -1.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r21 = cape.addOrReplaceChild("torso_r21", CubeListBuilder.create().texOffs(64, 16).addBox(-4.0F, -1.5F, -0.5F, 8.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r23 = cape.addOrReplaceChild("torso_r23", CubeListBuilder.create().texOffs(65, 53).addBox(-4.0F, -1.0F, -0.5F, 8.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-9.5706F, -11.2125F, 3.3169F, -0.3054F, 0.0F, 0.0F));
		PartDefinition torso_r24 = cape.addOrReplaceChild("torso_r24", CubeListBuilder.create().texOffs(30, 73).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-13.7154F, -11.1133F, 3.3169F, -0.3054F, 0.0F, -0.3054F));
		PartDefinition torso_r25 = cape.addOrReplaceChild("torso_r25", CubeListBuilder.create().texOffs(20, 70).addBox(-0.4992F, -1.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
