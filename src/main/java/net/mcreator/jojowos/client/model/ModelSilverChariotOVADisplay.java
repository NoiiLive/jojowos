...
public class ModelSilverChariotOVADisplay<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("jojowos", "model_silver_chariot_ova_display"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition faceplate2 = head.addOrReplaceChild("faceplate2",
				CubeListBuilder.create().texOffs(18, 0).addBox(-0.5F, -1.8603F, -0.499F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(35, 16).addBox(-2.15F, -1.8603F, -0.498F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(7, 95)
						.addBox(-3.5F, -2.2103F, -0.4F, 7.0F, 4.0F, 1.0F, new CubeDeformation(0.15F)).texOffs(21, 17).addBox(0.15F, -1.8603F, -0.498F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(63, 20)
						.addBox(-3.6252F, -2.3008F, -0.499F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(13, 32).addBox(1.6252F, -2.3008F, -0.499F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition torso = Body.addOrReplaceChild("torso",
				CubeListBuilder.create().texOffs(67, 58).addBox(-1.5F, 8.0F, -0.25F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 36).addBox(-2.0F, 11.0F, -2.001F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(62, 37)
						.addBox(-1.0F, 7.0F, -0.75F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 32).addBox(-2.5F, 11.0F, -1.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 62)
						.addBox(1.5F, 11.0F, -1.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -3.0F, 0.0F));
		PartDefinition torso_r1 = torso.addOrReplaceChild("torso_r1", CubeListBuilder.create().texOffs(41, 3).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.1272F, 10.252F, -0.0458F, -0.6318F, -0.1841F, -0.2451F));
		PartDefinition torso_r2 = torso.addOrReplaceChild("torso_r2", CubeListBuilder.create().texOffs(32, 37).addBox(-0.4999F, -1.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0748F, 10.209F, -0.375F, -1.1117F, -0.1841F, -0.2451F));
		PartDefinition torso_r3 = torso.addOrReplaceChild("torso_r3", CubeListBuilder.create().texOffs(35, 20).addBox(-0.5F, -0.5F, -0.4999F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.2525F, 9.6382F, 0.8469F, -0.9643F, 0.7009F, 0.2658F));
		PartDefinition torso_r4 = torso.addOrReplaceChild("torso_r4", CubeListBuilder.create().texOffs(21, 21).addBox(-0.5F, -0.3F, -0.4F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1904F, 9.228F, 0.9058F, 0.0183F, 1.1167F, 1.586F));
		PartDefinition torso_r5 = torso.addOrReplaceChild("torso_r5", CubeListBuilder.create().texOffs(0, 56).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.7902F, 9.4869F, 1.0084F, 0.1172F, 1.1167F, 1.5462F));
		PartDefinition torso_r6 = torso.addOrReplaceChild("torso_r6", CubeListBuilder.create().texOffs(6, 57).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.7902F, 9.4869F, 1.0084F, 0.1172F, -1.1167F, -1.5462F));
		PartDefinition torso_r7 = torso.addOrReplaceChild("torso_r7", CubeListBuilder.create().texOffs(31, 49).addBox(-0.5F, -0.5F, -0.4999F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.2525F, 9.6382F, 0.8469F, -0.9643F, -0.7009F, -0.2658F));
		PartDefinition torso_r8 = torso.addOrReplaceChild("torso_r8", CubeListBuilder.create().texOffs(54, 47).addBox(-0.5001F, -1.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0748F, 10.209F, -0.375F, -1.1117F, 0.1841F, 0.2451F));
		PartDefinition torso_r9 = torso.addOrReplaceChild("torso_r9", CubeListBuilder.create().texOffs(56, 13).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.1272F, 10.252F, -0.0458F, -0.6318F, 0.1841F, 0.2451F));
		PartDefinition torso_r10 = torso.addOrReplaceChild("torso_r10",
				CubeListBuilder.create().texOffs(60, 14).addBox(-0.501F, -0.5F, -0.4991F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(42, 13).addBox(-4.501F, -0.5F, -0.4991F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r11 = armor.addOrReplaceChild("torso_r11",
				CubeListBuilder.create().texOffs(47, 19).addBox(-1.0F, -1.0F, -0.501F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(68, 35).addBox(-1.0F, -1.0F, -5.499F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition torso_r12 = armor.addOrReplaceChild("torso_r12",
				CubeListBuilder.create().texOffs(36, 26).addBox(0.0F, -1.0F, -0.501F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(21, 69).addBox(0.0F, -1.0F, -5.499F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.8693F, -2.1939F, 2.5F, 0.0F, 0.0F, -0.5672F));
		PartDefinition torso_r13 = armor.addOrReplaceChild("torso_r13", CubeListBuilder.create().texOffs(34, 56).addBox(-0.5F, -1.0F, -2.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.75F, -1.0F, 0.0F, 0.0F, 0.0F, -0.0873F));
		PartDefinition torso_r14 = armor.addOrReplaceChild("torso_r14", CubeListBuilder.create().texOffs(56, 7).addBox(-0.5F, -1.0F, -2.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.75F, -1.0F, 0.0F, 0.0F, 0.0F, 0.0873F));
		PartDefinition torso_r15 = armor.addOrReplaceChild("torso_r15", CubeListBuilder.create().texOffs(47, 16).addBox(-4.0F, -1.0F, -0.5F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.0F, -2.0F, -0.0873F, 0.0F, 0.0F));
		PartDefinition torso_r16 = armor.addOrReplaceChild("torso_r16", CubeListBuilder.create().texOffs(0, 47).addBox(-4.0F, -1.0F, -0.5F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.0F, 2.0F, 0.0873F, 0.0F, 0.0F));
		PartDefinition torso_r17 = armor.addOrReplaceChild("torso_r17", CubeListBuilder.create().texOffs(0, 11).addBox(-4.0F, -1.0F, -0.5F, 7.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, 1.0F, -1.75F, -0.0873F, 0.0F, 0.0F));
		PartDefinition torso_r18 = armor.addOrReplaceChild("torso_r18", CubeListBuilder.create().texOffs(50, 55).addBox(-0.5F, -1.0F, -2.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.25F, 1.0F, 0.0F, 0.0F, 0.0F, -0.0873F));
		PartDefinition torso_r19 = armor.addOrReplaceChild("torso_r19", CubeListBuilder.create().texOffs(0, 56).addBox(-0.5F, -1.0F, -2.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.25F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0873F));
		PartDefinition torso_r20 = armor.addOrReplaceChild("torso_r20", CubeListBuilder.create().texOffs(48, 26).addBox(-4.0F, -1.0F, -0.5F, 7.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, 1.0F, 1.75F, 0.0873F, 0.0F, 0.0F));
		PartDefinition tubes = torso.addOrReplaceChild("tubes", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition torso_r21 = tubes.addOrReplaceChild("torso_r21", CubeListBuilder.create().texOffs(42, 11).addBox(-3.5F, -0.25F, -2.0F, 5.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.8524F, 11.813F, 0.0F, 0.0F, 0.0F, -0.7854F));
		PartDefinition torso_r22 = tubes.addOrReplaceChild("torso_r22", CubeListBuilder.create().texOffs(42, 11).mirror().addBox(-1.5F, -0.25F, -2.0F, 5.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(3.8524F, 11.813F, 0.0F, 0.0F, 0.0F, 0.7854F));
		...
		PartDefinition lowerarm = right_arm.addOrReplaceChild("lowerarm",
				CubeListBuilder.create().texOffs(18, 33).addBox(-1.0F, 0.0F, -2.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.001F)).texOffs(0, 41).addBox(-1.5F, 5.0F, -2.5F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(55, 69)
		...
		PartDefinition lowerarm2 = left_arm.addOrReplaceChild("lowerarm2",
				CubeListBuilder.create().texOffs(18, 33).mirror().addBox(-2.0F, 0.0F, -2.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.001F)).mirror(false).texOffs(0, 41).mirror().addBox(-2.5F, 5.0F, -2.5F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition left_leg = Body.addOrReplaceChild("left_leg",
				CubeListBuilder.create().texOffs(42, 53).addBox(-1.5F, -2.0F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(52, 3).addBox(-2.5F, 6.25F, -1.0F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition extra = lowerleg.addOrReplaceChild("extra",
				CubeListBuilder.create().texOffs(44, 42).addBox(-2.0F, 1.5F, 1.25F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(60, 25).addBox(-2.25F, 1.5F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(36, 30)
						.addBox(-2.0F, 1.5F, -2.25F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(26, 60).addBox(1.25F, 1.5F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition realleg2 = right_leg.addOrReplaceChild("realleg2",
				...
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition lowerleg2 = right_leg.addOrReplaceChild(
				"lowerleg2", CubeListBuilder.create().texOffs(52, 3).mirror().addBox(-2.5F, 0.25F, -1.0F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(28, 24).mirror()
						.addBox(-2.5F, 4.5F, 0.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(56, 55).mirror().addBox(-2.0F, 5.0F, -4.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 6.0F, 0.0F));
