...
import net.mcreator.jojowos.item.model.HierophantGreenPilotAnimeModel;
import net.mcreator.jojowos.item.HierophantGreenPilotAnimeItem;

public class HierophantGreenPilotAnimeArmorRenderer extends GeoArmorRenderer<HierophantGreenPilotAnimeItem> {
	public HierophantGreenPilotAnimeArmorRenderer() {
		super(new HierophantGreenPilotAnimeModel());
	...
	@Override
	public RenderType getRenderType(HierophantGreenPilotAnimeItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
