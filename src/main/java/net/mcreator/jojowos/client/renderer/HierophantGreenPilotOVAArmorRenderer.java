...
import net.mcreator.jojowos.item.model.HierophantGreenPilotOVAModel;
import net.mcreator.jojowos.item.HierophantGreenPilotOVAItem;

public class HierophantGreenPilotOVAArmorRenderer extends GeoArmorRenderer<HierophantGreenPilotOVAItem> {
	public HierophantGreenPilotOVAArmorRenderer() {
		super(new HierophantGreenPilotOVAModel());
	...
	@Override
	public RenderType getRenderType(HierophantGreenPilotOVAItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
