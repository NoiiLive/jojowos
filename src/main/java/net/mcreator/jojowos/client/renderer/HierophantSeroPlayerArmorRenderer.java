...
import net.mcreator.jojowos.item.model.HierophantSeroPlayerModel;
import net.mcreator.jojowos.item.HierophantSeroPlayerItem;

public class HierophantSeroPlayerArmorRenderer extends GeoArmorRenderer<HierophantSeroPlayerItem> {
	public HierophantSeroPlayerArmorRenderer() {
		super(new HierophantSeroPlayerModel());
	...
	@Override
	public RenderType getRenderType(HierophantSeroPlayerItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
