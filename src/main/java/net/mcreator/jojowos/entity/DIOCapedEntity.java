...
public class DIOCapedEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DIOCapedEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DIOCapedEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DIOCapedEntity.class, EntityDataSerializers.STRING);
	...
	public DIOCapedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojowosModEntities.DIO_CAPED.get(), world);
	}

	public DIOCapedEntity(EntityType<DIOCapedEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(JojowosModItems.DIO_CLOTHES_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(JojowosModItems.DIO_CAPE_CHESTPLATE.get()));
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.3, true) {
			...
			public boolean canUse() {
				double x = DIOCapedEntity.this.getX();
				double y = DIOCapedEntity.this.getY();
				double z = DIOCapedEntity.this.getZ();
				Entity entity = DIOCapedEntity.this;
				Level world = DIOCapedEntity.this.level();
		...
		this.targetSelector.addGoal(11, new NearestAttackableTargetGoal(this, OldJosephJoestarEntity.class, false, false) {
			@Override
			public boolean canUse() {
				double x = DIOCapedEntity.this.getX();
				double y = DIOCapedEntity.this.getY();
		...
		this.targetSelector.addGoal(12, new NearestAttackableTargetGoal(this, JeanPierrePolnareffEntity.class, false, false) {
			@Override
			public boolean canUse() {
				double x = DIOCapedEntity.this.getX();
				double y = DIOCapedEntity.this.getY();
		...
		this.targetSelector.addGoal(13, new NearestAttackableTargetGoal(this, NoriakiKakyoinEntity.class, false, false) {
			@Override
			public boolean canUse() {
				double x = DIOCapedEntity.this.getX();
				double y = DIOCapedEntity.this.getY();
		...
		this.targetSelector.addGoal(14, new NearestAttackableTargetGoal(this, IggyEntity.class, false, false) {
			@Override
			public boolean canUse() {
				double x = DIOCapedEntity.this.getX();
				double y = DIOCapedEntity.this.getY();
	...
	public static void init() {
		SpawnPlacements.register(JojowosModEntities.DIO_CAPED.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(DIOCapedEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
