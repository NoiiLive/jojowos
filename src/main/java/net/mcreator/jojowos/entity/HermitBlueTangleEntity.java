...
public class HermitBlueTangleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(HermitBlueTangleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(HermitBlueTangleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(HermitBlueTangleEntity.class, EntityDataSerializers.STRING);
	...
	public HermitBlueTangleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojowosModEntities.HERMIT_BLUE_TANGLE.get(), world);
	}

	public HermitBlueTangleEntity(EntityType<HermitBlueTangleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "hermittangleblue");
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		HermitBlueTangleEntity retval = JojowosModEntities.HERMIT_BLUE_TANGLE.get().create(serverWorld);
...
private float wrapDegrees(float degrees) {
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(HermitBlueTangleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
