...
public class HermitGoldTangleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(HermitGoldTangleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(HermitGoldTangleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(HermitGoldTangleEntity.class, EntityDataSerializers.STRING);
	...
	public HermitGoldTangleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojowosModEntities.HERMIT_GOLD_TANGLE.get(), world);
	}

	public HermitGoldTangleEntity(EntityType<HermitGoldTangleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "hermittanglegold");
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		HermitGoldTangleEntity retval = JojowosModEntities.HERMIT_GOLD_TANGLE.get().create(serverWorld);
...
private float wrapDegrees(float degrees) {
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(HermitGoldTangleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
