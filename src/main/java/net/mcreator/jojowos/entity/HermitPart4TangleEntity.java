...
public class HermitPart4TangleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(HermitPart4TangleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(HermitPart4TangleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(HermitPart4TangleEntity.class, EntityDataSerializers.STRING);
	...
	public HermitPart4TangleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojowosModEntities.HERMIT_PART_4_TANGLE.get(), world);
	}

	public HermitPart4TangleEntity(EntityType<HermitPart4TangleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "hermittanglepart4");
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		HermitPart4TangleEntity retval = JojowosModEntities.HERMIT_PART_4_TANGLE.get().create(serverWorld);
...
private float wrapDegrees(float degrees) {
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(HermitPart4TangleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
