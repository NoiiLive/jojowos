...
public class HermitVenomTangleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(HermitVenomTangleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(HermitVenomTangleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(HermitVenomTangleEntity.class, EntityDataSerializers.STRING);
	...
	public HermitVenomTangleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojowosModEntities.HERMIT_VENOM_TANGLE.get(), world);
	}

	public HermitVenomTangleEntity(EntityType<HermitVenomTangleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "hermitpurplevenomtangle");
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		HermitVenomTangleEntity retval = JojowosModEntities.HERMIT_VENOM_TANGLE.get().create(serverWorld);
...
private float wrapDegrees(float degrees) {
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(HermitVenomTangleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
