...
public class HierophantGreenEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(HierophantGreenEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(HierophantGreenEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(HierophantGreenEntity.class, EntityDataSerializers.STRING);
	...
	public HierophantGreenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojowosModEntities.HIEROPHANT_GREEN.get(), world);
	}

	public HierophantGreenEntity(EntityType<HierophantGreenEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "hierophantgreenanimetexture");
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		HierophantGreenEntity retval = JojowosModEntities.HIEROPHANT_GREEN.get().create(serverWorld);
...
private float wrapDegrees(float degrees) {
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(HierophantGreenEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
