...
public class IggySittingEntity extends Monster {
	public IggySittingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojowosModEntities.IGGY_SITTING.get(), world);
	}

	public IggySittingEntity(EntityType<IggySittingEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
