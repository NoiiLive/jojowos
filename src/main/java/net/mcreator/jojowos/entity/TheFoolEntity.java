...
public class TheFoolEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(TheFoolEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(TheFoolEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(TheFoolEntity.class, EntityDataSerializers.STRING);
	...
	public TheFoolEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JojowosModEntities.THE_FOOL.get(), world);
	}

	public TheFoolEntity(EntityType<TheFoolEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "thefoolanime");
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		TheFoolEntity retval = JojowosModEntities.THE_FOOL.get().create(serverWorld);
...
private float wrapDegrees(float degrees) {
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(TheFoolEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
