...
public class StandSkillTreeEvenButtonMessage {
	private final int buttonID, x, y, z;

	public StandSkillTreeEvenButtonMessage(FriendlyByteBuf buffer) {
	...
	public StandSkillTreeEvenButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StandSkillTreeEvenButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StandSkillTreeEvenButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StandSkillTreeEvenMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JojowosMod.addNetworkMessage(StandSkillTreeEvenButtonMessage.class, StandSkillTreeEvenButtonMessage::buffer, StandSkillTreeEvenButtonMessage::new, StandSkillTreeEvenButtonMessage::handler);
	}
}
