...
import net.mcreator.jojowos.procedures.AbilityKeybind2Procedure;
...
public class UseAbility2Message {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			AbilityKeybind2Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		JojowosMod.addNetworkMessage(UseAbility2Message.class, UseAbility2Message::buffer, UseAbility2Message::new, UseAbility2Message::handler);
	}
}
