...
import net.mcreator.jojowos.procedures.AbilityKeybind8Procedure;
...
public class UseAbility8Message {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			AbilityKeybind8Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		JojowosMod.addNetworkMessage(UseAbility8Message.class, UseAbility8Message::buffer, UseAbility8Message::new, UseAbility8Message::handler);
	}
}
