...
import net.mcreator.jojowos.procedures.SkillUsedProcedure;
...
public class UseSkillMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JojowosMod.addNetworkMessage(UseSkillMessage.class, UseSkillMessage::buffer, UseSkillMessage::new, UseSkillMessage::handler);
	}
}
