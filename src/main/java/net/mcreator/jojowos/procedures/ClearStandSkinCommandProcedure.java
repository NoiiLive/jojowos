...
public class ClearStandSkinCommandProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if (!((new Object() {
			...
			if ((new Object() {
				...
				_player.displayClientMessage(Component.literal("Stand Skins Have Been Cleared"), false);
			if (entity instanceof Player _player && !_player.level().isClientSide())
				...
				}.getEntity()).getDisplayName().getString() + "'s Stand Skins Have Been Cleared")), false);
		} else {
			if ((new Object() {
				public Entity getEntity() {
					try {
