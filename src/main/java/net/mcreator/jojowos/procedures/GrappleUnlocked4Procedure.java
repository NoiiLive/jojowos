...
public class GrappleUnlocked4Procedure {
	public static boolean execute(Entity entity) {
		...
		if (((entity.getCapability(JojowosModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JojowosModVariables.PlayerVariables())).MovesUnlocked)
				...
				&& ((entity.getCapability(JojowosModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JojowosModVariables.PlayerVariables())).SetAbility4).equals("Grapple")) {
			return true;
		}
		return false;
	}
