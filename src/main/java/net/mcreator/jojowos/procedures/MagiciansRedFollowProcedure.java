...
public class MagiciansRedFollowProcedure {
	public static void execute(Entity entity) {
		...
		if (((entity instanceof TamableAnimal _tamEnt ? (Entity) _tamEnt.getOwner() : null) instanceof LivingEntity _livEnt115 && _livEnt115.hasEffect(MobEffects.INVISIBILITY)) == false) {
		...
		} else if (((entity instanceof TamableAnimal _tamEnt ? (Entity) _tamEnt.getOwner() : null) instanceof LivingEntity _livEnt121 && _livEnt121.hasEffect(MobEffects.INVISIBILITY)) == true) {
