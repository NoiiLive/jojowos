...
public class PolnareffChatButton1Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
			...
			if (((entity.getCapability(JojowosModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JojowosModVariables.PlayerVariables())).ChatButton1).equals("What")) {
				...
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jojowos:polnareff_tsk")), SoundSource.HOSTILE, 1, 1);
					} else {
						_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jojowos:polnareff_tsk")), SoundSource.HOSTILE, 1, 1, false);
					}
				}
				{
					String _setval = "DontUnderstand";
					entity.getCapability(JojowosModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
		...
		if (((entity.getCapability(JojowosModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JojowosModVariables.PlayerVariables())).PolnareffChatStage).equals("QuestComplete") && gate == false) {
			if (((entity.getCapability(JojowosModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JojowosModVariables.PlayerVariables())).ChatButton1).equals("Yes")) {
				...
				if (entity instanceof Player _player)
					_player.closeContainer();
				PolnareffKillZombieQuestCompleteProcedure.execute(entity);
				PolnareffKillSkeletonQuestCompleteProcedure.execute(entity);
				PolnareffKillSpiderQuestCompleteProcedure.execute(entity);
				PolnareffKillCreeperQuestCompleteProcedure.execute(entity);
				PolnareffKillEndermenQuestCompleteProcedure.execute(entity);
				PolnareffKillPiglinQuestCompleteProcedure.execute(entity);
				PolnareffKillPillagerQuestCompleteProcedure.execute(entity);
			}
			gate = true;
		}
