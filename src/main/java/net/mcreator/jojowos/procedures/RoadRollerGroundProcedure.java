...
public class RoadRollerGroundProcedure {
		...
		if (ConfigFilesConfiguration.STANDBLOCKBREAKING.get() == true) {
				...
				_level.explode(null, x, y, z, 5, Level.ExplosionInteraction.BLOCK);
			{
				...
				for (Entity entityiterator : _entfound) {
					entityiterator.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypes.EXPLOSION)), 4);
				}
			}
		} else {
			{
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.EXPLOSION, (x + Mth.nextInt(RandomSource.create(), -5, 5)), (y + Mth.nextInt(RandomSource.create(), -1, 5)), (z + Mth.nextInt(RandomSource.create(), -5, 5)), 15, 1.5, 1.5, 1.5, 0.2);
		}
	}
}
