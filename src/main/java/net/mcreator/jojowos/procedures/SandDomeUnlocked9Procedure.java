...
public class SandDomeUnlocked9Procedure {
	public static boolean execute(Entity entity) {
		...
		if (((entity.getCapability(JojowosModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JojowosModVariables.PlayerVariables())).MovesUnlocked)
				...
				&& ((entity.getCapability(JojowosModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JojowosModVariables.PlayerVariables())).SetAbility9).equals("Sand Dome")) {
			return true;
		}
		return false;
	}
