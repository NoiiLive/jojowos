...
public class StandCrossfireSpecialProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		double cooldown = 0;
		usemove = false;
		subtract = ((double) MoveDirectoryConfiguration.CROSSFIRESPECIALCDMIN.get() - (double) MoveDirectoryConfiguration.CROSSFIRESPECIALCDMAX.get())
		...
		if (subtract != 0) {
			cooldown = (double) MoveDirectoryConfiguration.CROSSFIRESPECIALCDMAX.get()
