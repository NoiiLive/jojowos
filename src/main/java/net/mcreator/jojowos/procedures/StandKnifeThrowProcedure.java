...
public class StandKnifeThrowProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		double cooldown = 0;
		usemove = false;
		subtract = ((double) MoveDirectoryConfiguration.KNIFETHROWCDMIN.get() - (double) MoveDirectoryConfiguration.KNIFETHROWCDMAX.get())
		...
		if (subtract != 0) {
			cooldown = (double) MoveDirectoryConfiguration.KNIFETHROWCDMAX.get() + Math.round((entity.getCapability(JojowosModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JojowosModVariables.PlayerVariables())).StandSpeed * subtract);
		} else {
			cooldown = (double) MoveDirectoryConfiguration.KNIFETHROWCDMAX.get();
		}
		nocooldown = 25;
		move = "Knife Throw";
			...
			if (((entity.getCapability(JojowosModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JojowosModVariables.PlayerVariables())).Stand).equals("TheWorld")
				...
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jojowos:stw_knife_throw")), SoundSource.PLAYERS, 1, 1);
					} else {
						_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jojowos:stw_knife_throw")), SoundSource.PLAYERS, 1, 1, false);
					}
				}
			}
			if (world instanceof Level _level) {
