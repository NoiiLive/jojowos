...
public class StarPlatinumFollowProcedure {
	public static void execute(Entity entity) {
		...
		if (((entity instanceof TamableAnimal _tamEnt ? (Entity) _tamEnt.getOwner() : null) instanceof LivingEntity _livEnt106 && _livEnt106.hasEffect(MobEffects.INVISIBILITY)) == false) {
		...
		} else if (((entity instanceof TamableAnimal _tamEnt ? (Entity) _tamEnt.getOwner() : null) instanceof LivingEntity _livEnt112 && _livEnt112.hasEffect(MobEffects.INVISIBILITY)) == true) {
