...
public class TheWorldFollowProcedure {
	public static void execute(Entity entity) {
		...
		if (((entity instanceof TamableAnimal _tamEnt ? (Entity) _tamEnt.getOwner() : null) instanceof LivingEntity _livEnt102 && _livEnt102.hasEffect(MobEffects.INVISIBILITY)) == false) {
		...
		} else if (((entity instanceof TamableAnimal _tamEnt ? (Entity) _tamEnt.getOwner() : null) instanceof LivingEntity _livEnt108 && _livEnt108.hasEffect(MobEffects.INVISIBILITY)) == true) {
