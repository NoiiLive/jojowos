...
public class ZoomUnlocked7Procedure {
	public static boolean execute(Entity entity) {
		...
		if (((entity.getCapability(JojowosModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JojowosModVariables.PlayerVariables())).MovesUnlocked)
				...
				&& ((entity.getCapability(JojowosModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JojowosModVariables.PlayerVariables())).SetAbility7).equals("Zoom")) {
			return true;
		}
		return false;
	}
